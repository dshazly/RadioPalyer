package com.dushazly.radio.radioplayer.player
...
import com.dushazly.radio.radioplayer.listen_radio.ui.activity.RadioActivity
import com.dushazly.radio.radioplayer.R
import com.dushazly.radio.radioplayer.player.scheduler.myScheduler
...
class MediaNotificationManager(private val service: RadioService) {
    ...
    fun startNotify(playbackStatus: String) {
        ...
        val intent = Intent(service, RadioActivity::class.java)
